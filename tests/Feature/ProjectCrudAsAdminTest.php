...
class ProjectCrudAsAdminTest extends TestCase
{
    ...
    public function test_admin_access_to_project_index()
    {
    ...
    public function test_admin_access_to_project_create()
    {
        $this->actingAs($this->admin)
             ...
             ->assertSee('Project create');
    }

    public function test_admin_access_to_project_store()
    {
        $this->actingAs($this->admin)
    ...
    public function test_admin_access_to_project_show()
    {
    ...
    public function test_admin_access_to_project_edit()
    {
        ...
        $this->actingAs($this->admin)
             ...
             ->assertViewHas('project')
             ->assertSee('Project edit');
    }

    public function test_admin_access_to_project_update()
    {
        $projectToUpdate = Project::first();
        ...
        $this->actingAs($this->admin)
             ...
             ->assertStatus(302)
             ->assertRedirect(route('project.edit', $projectToUpdate->id))
        ...
        $this->assertEquals('Project title updated', $updatedProject->title);
    }

    public function test_admin_access_to_project_destroy()
    {
    ...
    public function test_admin_access_to_project_deleted()
    {
        $this->actingAs($this->admin)
             ->from(route('project.index'))
    ...
    public function test_admin_access_to_project_restore()
    {
        ...
        $this->actingAs($this->admin)
             ...
             ->assertStatus(302)
             ->assertRedirect(route('project.deleted'))
