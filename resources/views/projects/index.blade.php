                                            ...
                                            <div id="dropdownAction{{$loop->index}}"
                                                ...
                                                <div class="py-1">
                                                    <x-simple-button
                                                        ...
                                                        x-data=""
                                                        x-on:click.prevent="$dispatch('open-modal', 'confirm-client-deletion{{$loop->index}}')"
                                                    >{{ __('Delete') }}</x-simple-button>
                                                </div>
                                            </div>
                                            <x-modal name="confirm-client-deletion{{$loop->index}}" focusable>
                                                <form action="{{route('projects.destroy', $project)}}" method="POST" class="p-6">
                                                    @csrf
                                                    @method('delete')
                                                    ...
                                                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                                        {{ __('Once this project is deleted, all of its resources and data will be unreachable.') }}
                                                    </p>
