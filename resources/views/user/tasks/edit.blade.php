                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.projects.update', $project->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" class="form-control @error('description') is-invalid @enderror" name="description" value="{{ old('description', $task->description) }}" required autocomplete="description"></textarea>
