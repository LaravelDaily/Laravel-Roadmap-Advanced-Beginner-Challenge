...
class TaskController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('user.task.create', compact('projects'));
    }
    ...
    public function store(Request $request, Task $task)
    {
        ...
        return redirect()->route('user.task.index')->with('success', 'Task Created');
    }
    ...
    public function update(Request $request, Task $task)
    {
        ...
        $task->update($validated);
        return redirect()->route('user.task.index')->with('success', 'Task Updated');
    ...
    public function destroy( Task $task )
    {
        ...
        $task->delete();
        return redirect()->route('user.task.index')->with('success', 'Task Deleted');
    }
}
